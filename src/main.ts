...
new Slider("octaveSlider", document.getElementById("octaveSliderContainer")!, 1, 20, pp.settings.nbOctaves, (val: number) => {
...
new Slider("domainWarpingStrengthSlider", document.getElementById("domainWarpingStrengthSliderContainer")!, 1, 10, pp.settings.domainWarpingStrength, (val: number) => {
    pp.settings.domainWarpingStrength = val;
});

new Slider("frequencySlider", document.getElementById("frequencySliderContainer")!, 1, 20, pp.settings.frequency, (val: number) => {
    pp.settings.frequency = val;
});

new Slider("levelLinesSlider", document.getElementById("levelLinesSliderContainer")!, 2, 20, pp.settings.nbLines, (val: number) => {
